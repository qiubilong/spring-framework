...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	...
	public void refresh() throws BeansException, IllegalStateException {/* 启动ApplicationContext容器 */
		synchronized (this.startupShutdownMonitor) {
			...
			/* 模板方法，获取DefaultListBeanFactory，不存在则创建 */
			...
			try {
				...
				// Initialize message source for this context.  //国际化资源 DelegatingMessageSource
				initMessageSource();

				// Initialize event multicaster for this context. //事件广播器SimpleApplicationEventMulticaster
	...
	protected void prepareRefresh() {
		...
		//模板方法设计模式，用于子类加载配置，如WebContext加载Servlet参数
		initPropertySources();
	...
	protected void prepareBeanFactory(ConfigurableListableBeanFactory beanFactory) {
		...
		/* Aware回调 - BeanPostProcessor */
		beanFactory.addBeanPostProcessor(new ApplicationContextAwareProcessor(this));
		/* autowireByType或者autowireByName忽略以下setXXXAware方法 */
	...
	protected void invokeBeanFactoryPostProcessors(ConfigurableListableBeanFactory beanFactory) {
		/* 寻找BeanDefinitionRegistryPostProcessor -- > 调用postProcessBeanDefinitionRegistry -> 扫描注册BeanDefinition */
		PostProcessorRegistrationDelegate.invokeBeanFactoryPostProcessors(beanFactory, getBeanFactoryPostProcessors());
		//BeanDefinitionRegistryPostProcessor是BeanFactoryPostProcessor
